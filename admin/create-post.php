                                ...
                                <div class="card-body">
                                    <form method="post">
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-sm-12 col-md-7">
                                                <button type="submit" name="postsubmit" class="btn btn-primary">Publish</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
...
if (isset($_POST['postsubmit'])) {
    ...
    $queryMysql = mysqli_query($conn, "INSERT INTO `post_data` (`id`, `title`, `category`, `body`, `userid`, `datetime`) VALUES (NULL, '$title', '$categoty', '$editordata', '$userID', '$date');");
    ...
    if ($queryMysql) {
        ...
        Swal.fire({
            ...
            window.location.href = '" . $GLOBALS['rootlink'] . "/admin/create-post.php';
        });
        </script>";
    } else {
        echo "<script>
        Swal.fire('Oops...', 'Posting failed!', 'error').then(function() {
            window.location.href = '" . $GLOBALS['rootlink'] . "/admin/create-post.php';
        });
        </script>";
    }
